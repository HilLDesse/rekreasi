...
function updateProgress(sceneIndex) {
    ...
    if (progressBarElement) {
        const beforeElement = window.getComputedStyle(progressBarElement, '::before');
...
// Touch/Click event for particle burst
let lastBurstTime = 0;
const burstCooldown = 300; // milliseconds
...
// =========================================================
// 12. SMOOTH SCROLL PREVENTION (Keep in viewport)
// =========================================================
...
console.log('%cSemoga pacarmu terkesan! 🌸', 'color: #FFB6C1; font-size: 14px; font-style: italic;');

// =========================================================
// 16. PRELOAD OPTIMIZATION
// =========================================================
